...
export default function OrgPad() {
  return (
      <body>
        <Navbar />
        <section className="main mt-28 mx-10">
            <div className="flex">
                <div className="p-4">
                    <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                        OrgPad
                    </h1>
                    <p className="mt-2 text-sm text-muted-foreground">Všechny OrgStránky</p>
                </div>
                <div className="p-4">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-56">
                            ...
                            <DropdownMenuSeparator/>
                            <Link href="/ucivo/orgpad/prvni-rocnik">
                                <DropdownMenuItem className="hover:cursor-pointer">
                                    <span>1. ročník</span>
                                </DropdownMenuItem>
                            </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Card className="w-[350px]">
                        ...
                        <CardFooter>
                            <Button className="w-full" asChild>
                                <Link href="https://orgpad.info/o/DAMEg4JFBBmYU0jCOAwP2s" target="_blank">
                ...
                <div>
                    <Card className="w-[350px]">
                        ...
                        <CardFooter>
                            <Button className="w-full" asChild>
                                <Link href="https://orgpad.info/o/Bz5fAdvK1LiIpCZdU0ygaI" target="_blank">
                                    <ExternalLink className="mr-2 w-4 h-4"/>
                                    Otevřít
                                </Link>
                            </Button>
                ...
                <div>
                    <Card className="w-[350px]">
                        ...
                        <CardFooter>
                            <Button className="w-full" asChild>
                                <Link href="https://orgpad.info/o/AVMyONSvBAA7wi0e-zTMA9" target="_blank">
                                    <ExternalLink className="mr-2 w-4 h-4"/>
                                    Otevřít
                                </Link>
                            </Button>
                ...
                <div>
                    <Card className="w-[350px]">
                        ...
                        <CardFooter>
                            <Button className="w-full" asChild>
                                <Link href="https://orgpad.info/o/AADtxVDJlImqfeeaDXcvFM" target="_blank">
                                    <ExternalLink className="mr-2 w-4 h-4"/>
                                    Otevřít
                                </Link>
                            </Button>
                ...
                <div>
                    <Card className="w-[350px]">
                        ...
                        <CardFooter>
                            <Button className="w-full" asChild>
                                <Link href="https://orgpad.info/o/ADlMfjVrxJ6bxm9hqWu7w8" target="_blank">
                                    <ExternalLink className="mr-2 w-4 h-4"/>
                                    Otevřít
                                </Link>
                            </Button>
