...
export const metadata: Metadata = {
    title: "Mgr. Vladimír Roller – Miňonky Učivo",
    description: "Generated by create next app",
};

export default function RollerOrgPad() {
    return (
    <body>
    <Navbar/>
    <section className="main mt-20 mx-14">
        <div className="flex justify-between">
                <div className="p-4">
                    ...
                    <h6 className="mt-2 text-sm text-muted-foreground">Položky od Mgr. Vladimír Roller</h6>
                </div>
                <div className="p-4">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-56">
                            ...
                            <DropdownMenuSeparator/>
                            <Link href="/ucivo/orgpad/student/kopecky">
